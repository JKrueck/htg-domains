...
if __name__ == "__main__":
    instance_name = "powerplantInstance"
    num_transformers = [1,2,3,4,5,6,7]  # Number of transformer blocks
    houses_per_block = [3,5,10,20,30,40,40,60,70,80,90,100,200,220,230, 250, 260, 280, 300]  # Number of houses per block (non-clique, reachable structure)
    
    for num_trans in num_transformers:
        for houses in houses_per_block:
            save_pddl_problem(instance_name+str(num_trans)+"Transfomer"+str(houses)+"Houses", num_trans, houses)
